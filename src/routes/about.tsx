...
const features = [
  {
    ...
    text: "Большая личная коллекция — от классики рока и джаза до редких изданий и современных переизданий.",
  },
  {
    icon: Users,
  ...
  },
  {
    icon: Droplets,
    title: "Мойка винила",
    text: "Каждую пластинку лично мою и проверяю перед продажей — чистый звук без щелчков и пыли.",
  },
  {
    icon: Truck,
